const menu = {
    ...
    getRandomDishFromCourse(courseName) {
        const dishes = [].concat(this.courses.appetizers,
            this.courses.mains,
            this.courses.desserts)
        const temp = Math.random() * dishes.length;
...
menu.addDishToCourse('appetizers', 'Mozatrells sticks', 9.25);
menu.addDishToCourse('appetizers', 'Fried piclkes', 10.25);
menu.addDishToCourse('mains', 'Lobster', 16.25);
menu.addDishToCourse('mains', 'Fish', 49.25);
menu.addDishToCourse('mains', 'Meat', 25.25);
menu.addDishToCourse('desserts', 'Chocolate', 5.25);
menu.addDishToCourse('desserts', 'Ice cream', 5.25);
menu.addDishToCourse('desserts', 'Cake', 5.25);
